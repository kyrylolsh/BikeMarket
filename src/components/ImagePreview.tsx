              ...
              <div className="rounded-2xl border-2 border-dashed border-gray-300 p-8">
                ...
                <label className="block cursor-pointer text-center">
                  ...
                  <p className="mt-2 text-gray-500">
                    Можна вибрати кілька фотографій
                  </p>
                ...
                <>
                  ...
                  <DndContext
                    ...
                    onDragEnd={(event) => {
                      ...
                      const oldIndex = form.images.indexOf(
                        active.id as string
                      );

                      const newIndex = form.images.indexOf(
                        over.id as string
                      );
                  ...
                  <div className="rounded-xl bg-blue-50 p-4 text-sm text-gray-600">
                    💡 Перетягніть фотографії, щоб змінити їх порядок.
                    Перше фото буде головним і відображатиметься в каталозі.
                  </div>
                </>
              )}
